...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        return self.cells if self.cells == self.count else set()
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = Sentence(neighbours, count - found_mines_count)
    ...
    def make_random_move(self):
        ...
        return possible_cells[random.randint(0, len(possible_cells) - 1)] if len(possible_cells) > 0 else None
